...
{
    bool latitud_en_rango = c.Latitud() < grl.CantFilas();
    bool longitud_en_rango = c.Longitud() < grl.CantColumnas();
    bool hay_un_camino_hacia_algun_lado = !(grl(c.Latitud(),c.Longitud()).caminos.EsVacio());

    return latitud_en_rango && longitud_en_rango && hay_un_camino_hacia_algun_lado;
}
